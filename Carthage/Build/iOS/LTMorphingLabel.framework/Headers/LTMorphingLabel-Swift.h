...
SWIFT_CLASS("_TtC15LTMorphingLabel15LTMorphingLabel")
...
@property (nonatomic) id <LTMorphingLabelDelegate> delegate;
@property (nonatomic, copy, getter=text, setter=setText:) NSString * text;
- (void)setNeedsLayout;
...
@interface LTMorphingLabel (SWIFT_EXTENSION(LTMorphingLabel))
@end
...
SWIFT_PROTOCOL("_TtP15LTMorphingLabel23LTMorphingLabelDelegate_")
@protocol LTMorphingLabelDelegate
@optional
- (void)morphingDidStart:(LTMorphingLabel *)label;
- (void)morphingDidComplete:(LTMorphingLabel *)label;
- (void)morphingOnProgress:(LTMorphingLabel *)label :(float)progress;
@end
